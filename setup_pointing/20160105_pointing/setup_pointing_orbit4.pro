pro setup_pointing_orbit4

                                ; Orbit 1 start:

  tstart_orb1 = '2016-01-05T18:51:10'
  tend_orb1 = '2016-01-05T19:54:20'
...
;  dwell = double(220.)          ; seconds
  dwell /= 86400.               ; days
  aim_times = dindgen(tiles) * dwell + tstart_jd[0] + 0.5 * dwell
...
;  ysteps = [ysteps, 0]
  ...
  print, 'Box PA angle:', (box_pa[0] + 360) mod 360 
