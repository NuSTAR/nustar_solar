; Wrapper code for sub_map that extracts a subset of a larger map
; object.
; Originally written by LG, renamed by BG.

FUNCTION nustar_make_submap, map, refmap, xrange=xrange, yrange=yrange, drot_time=drot_time, $
