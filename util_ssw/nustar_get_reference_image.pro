PRO nustar_get_reference_image, infile, outdir = outdir, outfile = outfile
...
outfile = outdir+'/'+file_basename(infile, '.evt')+'_ref_map.fits'
...
records = vso_search( ref_tstart, ref_tend, inst='AIA', wave=94 )     ; searches VSO
