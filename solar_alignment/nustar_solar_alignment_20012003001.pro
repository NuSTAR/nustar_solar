...
;;;;; you want to run.
indir = '/users/bwgref/lif_nustar/sol/data/20012003_Sol_14305_AR2192_3/20012003001/event_cl'
infile = 'nu20012003001A06_cl.evt'
...
; This is an "empty" pointing, so use a null alignment offset:
